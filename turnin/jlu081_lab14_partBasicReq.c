 ...
 *  Partner(s) Name: 
 *	Lab Section: 23
 *	Assignment: Lab #14  Exercise #Basic requirement
 *	Exercise Description: Doesn't include any advancements. This is only the basic requirement which shows the ball bouncing off the paddles and walls in the correct way as described in the manual. The AI uses a simple random number generator and the buttons on PA0 and PA1 move the user's paddle up and down. 
 *
 *	I acknowledge all content contained herein, excluding template or example
 *	code, is my own original work.
 *
 *	Demo link: https://youtu.be/YDWA3tOf0hQ
 *
 */
#include <avr/io.h>
#ifdef _SIMULATE_
...
void AITick() {
	// starting point of AI paddles
        ...
        // row of AI paddle
        static unsigned char row2 = 0E3;      // Row(s) displaying pattern.
